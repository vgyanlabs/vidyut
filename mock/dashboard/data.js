...
export const userCourses = [
  {
    ...
    level: "Intermediate",
    description: "Master modern JavaScript features, closures, promises, and advanced design patterns.",
    color: "bg-blue-500",
    totalModules: 12,
    completedModules: 9,
  ...
  },
  {
    ...
    level: "Beginner",
    description: "Learn component-based architecture, hooks, state management, and React best practices.",
    color: "bg-purple-500",
    totalModules: 8,
    completedModules: 4,
  ...
  },
  {
    ...
    level: "Advanced",
    description: "Build scalable server-side applications with Node.js, Express, and modern backend techniques.",
    color: "bg-green-500",
    totalModules: 15,
    completedModules: 5,
